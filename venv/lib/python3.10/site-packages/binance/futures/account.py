...
def new_batch_order(self, batchOrders: list):
    ...
    :parameter batchOrders: list. Where batchOrders is the list of order parameters in JSON.
    :parameter recvWindow: optional int.
    |
    """
...
def countdown_cancel_order(self, symbol: str, countdownTime: int, **kwargs):
    ...
    :parameter symbol: string.
    :parameter countdownTime: int. Countdown time, 1000 for 1 second. 0 to cancel the timer.
    :parameter recvWindow: optional int.
    |
    """
...
def get_account_trades(self, symbol: str, **kwargs):
    ...
    :parameter limit: optional int. Defaul 500, max 1000.
    :parameter recvWindow: optional int.
    |
    """
...
def get_income_history(self, **kwargs):
    ...
    :parameter endTime: optional int. Timestamp in ms to get funding until INCLUSIVE.
